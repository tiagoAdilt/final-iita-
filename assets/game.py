...
asset_sound= audio_path('assets/audios/background_misic.mp3')
backgound_sound = pygame.mixer.music.load(asset_sound)

#Cargar imagen del jugador
asset_playerimg = resourse_path('assets/images/espace-invaders.png')
playermig= pygame.image.load(asset_playerimg)

#Cargar imagen de balas
asset_bulleting = resourse_path('assets/images/bullet.png')
...
asset_ = resourse_path('assets/fonts/comicbd.ttf')
